    ...
    <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto px-4">
      {projects.map((project, i) => (
        <motion.a
          ...
          whileHover={{ y: -10 }}
          className="group block bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all"
        >
          <div className="bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 h-48 flex items-center justify-center">
